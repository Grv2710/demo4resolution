  ...
  return (
    <div className="container-fluid tangerine s-h-full p-0" ref={widthRef}>
      <div ref={heightRef} className="h-100 w-100">
        <div
          className="row d-flex d-md-none justify-content-center align-items-center h-100 m-bg m-0"
          style={{ fontSize: "3cqi" }}
        >
          ...
          <div className="col-11 bg-white round-1 text-center pd-y-5 br-1">
            ...
            <button className="fs-20 btn w-50 solid_btn_primary br-05 mg-b-1">
              Sign in
            </button>
            ...
            <p className="fs-20 mb-0 fw-500 mg-b-1">Dimensions: {width} X {height}</p>
          </div>
        </div>
              ...
              <div className="col-md-5 bg-white round-1">
                <div className="row justify-content-center pd-y-5 h-100">
                  <div className="col-8 d-flex flex-column justify-content-between">
                    ...
                    <div>
                      <button className="fs-20 btn w-100 mt-4 solid_btn_primary br-05">
                        Sign in
                      </button>
                      ...
                      <p className="fs-20 mb-0 fw-500 mg-b-1 text-center mg-t-05">Dimensions: {width} X {height}</p>
                    </div>
                  </div>
                </div>
              </div>
